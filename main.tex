...
%% article.
\begin{abstract}
Exploring and visualizing a complex model in a single view can be very challenging. It requires considerable computational resources and can lead to information overload, making the model difficult to comprehend.
Picto Web is a tool designed for complex model exploration. Using model-to-text transformations in Epsilon Generation Language, it transforms domain-specific models into transient web-based views in different formats (e.g., HTML, Graphviz, PlantUML). 
